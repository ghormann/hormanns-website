...
photos:
  ...
  - src: "images/vote_design.png"
    caption: "Voting System Architecture"
...
- The front-end website is a simple single-page website with five tabs. It was developed using [Vue.js](https://vuejs.org/) to be both reactive and mobile friendly. The [front-end source code](https://github.com/ghormann/Christmas-Vote-now/tree/master/frontend) is public.
