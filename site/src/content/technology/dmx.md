...
Prior to 2014, all of the hardware we leveraged was basically just tricks for switching AC circuits on and off. Although the LOR controller supported dimming, it implemented this by switching the AC current to a normal outlet on and off very quickly. The challenge with this technology is that you were still switch entire strings of lights on and off. (See [8-port parallel controller](/technology/parallel-8/) and [320-port parallel controller](/technology/parallel-320/) for more information)
